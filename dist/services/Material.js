...
var MaterialService = /*#__PURE__*/function () {
  ...
  _createClass(MaterialService, [{
      ...
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _database["default"].material.create({
                data: data
              });
            case 2:
      ...
      var _findAll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _database["default"].material.findMany();
            case 2:
      ...
      var _findOne = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _database["default"].material.findUnique({
                where: {
                  id: id
                }
              });
      ...
      var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, data) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _database["default"].material.update({
                where: {
                  id: id
                },
                data: data
      ...
      var _delete2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _database["default"].material["delete"]({
                where: {
                  id: id
                }
              });
            case 2:
              ...
              return _context5.abrupt("return", material);
            case 4:
            case "end":
    ...
    key: "deleteAll",
    value: function () {
      var _deleteAll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var materials;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return _database["default"].material.deleteMany({});
            case 2:
              materials = _context6.sent;
              return _context6.abrupt("return", materials);
            case 4:
            case "end":
...
var MaterialServiceInstance = new MaterialService();
var _default = MaterialServiceInstance;
