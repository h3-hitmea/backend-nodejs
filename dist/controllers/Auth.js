...
var Auth = /*#__PURE__*/_createClass(function Auth() {
  ...
  _defineProperty(this, "login", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, reply, done, app) {
      var _request$body, email, password, remember_me, user, isPasswordValid, _, userData, token;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _request$body = request.body, email = _request$body.email, password = _request$body.password, remember_me = _request$body.remember_me;
            _context.next = 4;
          ...
          case 16:
            _ = user.password, userData = _objectWithoutProperties(user, _excluded);
