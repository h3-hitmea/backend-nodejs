...
var Auth = /*#__PURE__*/_createClass(function Auth() {
  ...
  _defineProperty(this, "login", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, reply, done, app) {
      var _request$body, email, password, descriptor, user, descriptor1, descriptor2, threshold, distance, _, _userData, _token, userData, token;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 11:
            descriptor1 = new Float32Array(JSON.parse(user.descriptor));
            descriptor2 = new Float32Array(JSON.parse(descriptor));
            threshold = 0.6; // Calculate the Euclidean distance between descriptors
            distance = (0, _faceRecongnition.calculateEuclideanDistance)(descriptor1, descriptor2);
            ...
            _ = user.password, _userData = _objectWithoutProperties(user, _excluded);
            _token = app.jwt.sign(_userData, {
              expiresIn: '1h'
            });
            reply.status(_httpStatusCodes.StatusCodes.ACCEPTED).send({
              token: _token
            });
            _context.next = 24;
            break;
          ...
          case 24:
            userData = _extends({}, (_objectDestructuringEmpty(user), user));
  ...
  _defineProperty(this, "logout", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next, app) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            decodeToken = app.jwt.decode(token);
            _context2.next = 5;
            return app.jwt.sign(decodeToken, {
              expiresIn: '1s'
            });
          case 5:
            res.send({
